...
class RecappWindow(Gtk.ApplicationWindow):
    ...
    _popover_preferences_button = Gtk.Template.Child()
    ...
    _sound_rowbox = Gtk.Template.Child() # was _audio_rowbox
...
# Preferences box
    ...
    @Gtk.Template.Callback()
    def on__popover_preferences_button_clicked(self, widget):
...
# Launch About Dialog
    ...
    @Gtk.Template.Callback()
    def on__popover_about_button_clicked(self, widget):
